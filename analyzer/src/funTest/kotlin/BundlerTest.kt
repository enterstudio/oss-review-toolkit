...
private val projectDir = File("src/funTest/assets/projects/synthetic/bundler")
...
class BundlerTest : StringSpec() {
    ...
    init {
        ...
        "Project dependencies are detected correctly" {
            val packageFile = File(projectDir, "Gemfile.lock")
            val result = Bundler.create().resolveDependencies(projectDir, listOf(packageFile))[packageFile]
